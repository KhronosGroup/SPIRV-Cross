...
typedef enum spvc_compiler_option
{
    ...
    SPVC_COMPILER_OPTION_MSL_XFB_COUNTER_BUFFER_INDEX_BASE = 89 | SPVC_COMPILER_OPTION_MSL_BIT,
    SPVC_COMPILER_OPTION_MSL_XFB_OUTPUT_BUFFER_INDEX_BASE = 90 | SPVC_COMPILER_OPTION_MSL_BIT,
