...
typedef enum spvc_compiler_option
{
	...
	SPVC_COMPILER_OPTION_MSL_RAY_TRACING_ACCELERATION_STRUCTURE_ADDRESS_TABLE_BUFFER_INDEX =
		103 | SPVC_COMPILER_OPTION_MSL_BIT,
	SPVC_COMPILER_OPTION_MSL_ENABLE_RAY_TRACING_POSITION_FETCH = 104 | SPVC_COMPILER_OPTION_MSL_BIT,
