...
typedef enum spvc_compiler_option
{
	...
	SPVC_COMPILER_OPTION_MSL_EMULATE_REVERSED_DEPTH_VIEWPORT = 95 | SPVC_COMPILER_OPTION_MSL_BIT,
	SPVC_COMPILER_OPTION_MSL_REVERSED_DEPTH_VIEWPORT_BUFFER_INDEX = 96 | SPVC_COMPILER_OPTION_MSL_BIT,
