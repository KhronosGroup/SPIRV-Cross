...
private:
	...
	void analyze_meshlet_writes(uint32_t func_id, uint32_t id_payload, const uint32_t id_per_vertex, const uint32_t id_per_primitive, std::unordered_set<uint32_t> &processed_func_ids);
