...
constant unsafe_array<float2,2> _67 = unsafe_array<float2,2>({ float2(0.0), float2(0.0) });
...
vertex main0_out main0(main0_in in [[stage_in]], constant type_View& View [[buffer(0)]], constant type_Primitive& Primitive [[buffer(1)]], texture2d<float> BoneMatrices [[texture(0)]])
{
    main0_out out = {};
    ...
    unsafe_array<float2,2> _72 = unsafe_array<float2,2>({ float2(0.0), float2(0.0) });
