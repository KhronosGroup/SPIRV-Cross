...
kernel void main0(main0_in in [[stage_in]], const device type_StructuredBuffer_v4float& View_PrimitiveSceneData [[buffer(0)]], constant type_View& View [[buffer(1)]], uint gl_InvocationID [[thread_index_in_threadgroup]], uint gl_PrimitiveID [[threadgroup_position_in_grid]], device main0_out* spvOut [[buffer(28)]], constant uint* spvIndirectParams [[buffer(29)]], device main0_patchOut* spvPatchOut [[buffer(27)]], device MTLTriangleTessellationFactorsHalf* spvTessLevel [[buffer(26)]], threadgroup main0_in* gl_in [[threadgroup(0)]])
{
    ...
    {
        float4 _426 = temp_var_hullMainRetVal[0u].WorldPosition[0];
        float4 _428 = temp_var_hullMainRetVal[0u].WorldPosition[1];
        float4 _430 = temp_var_hullMainRetVal[0u].WorldPosition[2];
        float4 _432 = temp_var_hullMainRetVal[1u].WorldPosition[0];
        float4 _434 = temp_var_hullMainRetVal[1u].WorldPosition[1];
        float4 _436 = temp_var_hullMainRetVal[1u].WorldPosition[2];
        float4 _438 = temp_var_hullMainRetVal[2u].WorldPosition[0];
        float4 _440 = temp_var_hullMainRetVal[2u].WorldPosition[1];
        float4 _442 = temp_var_hullMainRetVal[2u].WorldPosition[2];
        float4 _448 = (((((_428 + _430) + _434) + _436) + _440) + _442) * float4(0.16666667163372039794921875);
        float4 _461 = _140;
        ...
        for (;;)
        {
            ...
            float4 _492 = View.View_TranslatedWorldToClip * float4(_426.xyz, 1.0);
            float3 _493 = _492.xyz;
            float3 _494 = _487.xyz;
            float _496 = _492.w;
            float _497 = _487.w;
            bool3 _500 = (_493 - _494) < float3(_496 + _497);
            bool3 _506 = (_493 + _494) > float3((-_496) - _497);
            float4 _514 = View.View_TranslatedWorldToClip * float4(_432.xyz, 1.0);
            float3 _515 = _514.xyz;
            float _517 = _514.w;
            bool3 _520 = (_515 - _494) < float3(_517 + _497);
            bool3 _526 = (_515 + _494) > float3((-_517) - _497);
            float4 _535 = View.View_TranslatedWorldToClip * float4(_438.xyz, 1.0);
            float3 _536 = _535.xyz;
            float _538 = _535.w;
            bool3 _541 = (_536 - _494) < float3(_538 + _497);
            bool3 _547 = (_536 + _494) > float3((-_538) - _497);
            if (any((((int3(_500.x ? int3(1).x : int3(0).x, _500.y ? int3(1).y : int3(0).y, _500.z ? int3(1).z : int3(0).z) + (int3(2) * int3(_506.x ? int3(1).x : int3(0).x, _506.y ? int3(1).y : int3(0).y, _506.z ? int3(1).z : int3(0).z))) | (int3(_520.x ? int3(1).x : int3(0).x, _520.y ? int3(1).y : int3(0).y, _520.z ? int3(1).z : int3(0).z) + (int3(2) * int3(_526.x ? int3(1).x : int3(0).x, _526.y ? int3(1).y : int3(0).y, _526.z ? int3(1).z : int3(0).z)))) | (int3(_541.x ? int3(1).x : int3(0).x, _541.y ? int3(1).y : int3(0).y, _541.z ? int3(1).z : int3(0).z) + (int3(2) * int3(_547.x ? int3(1).x : int3(0).x, _547.y ? int3(1).y : int3(0).y, _547.z ? int3(1).z : int3(0).z)))) != int3(3)))
            {
                _587 = float4(0.0);
                break;
            }
            float3 _556 = _426.xyz - _432.xyz;
            float3 _557 = _432.xyz - _438.xyz;
            float3 _558 = _438.xyz - _426.xyz;
            float3 _561 = (float3(0.5) * (_426.xyz + _432.xyz)) - float3(View.View_TranslatedWorldCameraOrigin);
            float3 _564 = (float3(0.5) * (_432.xyz + _438.xyz)) - float3(View.View_TranslatedWorldCameraOrigin);
            float3 _567 = (float3(0.5) * (_438.xyz + _426.xyz)) - float3(View.View_TranslatedWorldCameraOrigin);
        ...
        patchOut.out_var_PN_POSITION9 = _448 + ((_448 - (((_438 + _432) + _426) * float4(0.3333333432674407958984375))) * float4(0.5));
    }
}
