...
{
    rayQuery.reset(::metal::raytracing::ray(float3(0.0), float3(1.0), 0.00999999977648258209228515625, 1.0), tlas[inputId], (255u & 255u), spvMakeIntersectionParams(0u));
...
{
    rayQuery_1.reset(::metal::raytracing::ray(float3(0.0), float3(1.0), 0.00999999977648258209228515625, 1.0), tlas, (255u & 255u), spvMakeIntersectionParams(0u));
