...
{
    rayQuery.reset(::metal::raytracing::ray(rayOrigin, rayDirection, 0.001000000047497451305389404296875, rayDistance), topLevelAS, (255u & 255u), spvMakeIntersectionParams(4u));
    for (;;)
    {
