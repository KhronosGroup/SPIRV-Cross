...
[[ patch(triangle, 0) ]] vertex main0_out main0(main0_patchIn patchIn [[stage_in]], constant type_ShadowDepthPass& ShadowDepthPass [[buffer(0)]], float3 gl_TessCoord [[position_in_patch]])
{
    ...
    float4 _164 = ((((((((((patchIn.gl_in[0u][0u].x * float4(_119)) * _127) + ((patchIn.gl_in[1u][0u].x * float4(_120)) * _131)) + ((patchIn.gl_in[2u][0u].x * float4(_121)) * _136)) + ((patchIn.gl_in[0u][0u].y * _139) * _131)) + ((patchIn.gl_in[0u][0u].z * _143) * _127)) + ((patchIn.gl_in[1u][0u].y * _143) * _136)) + ((patchIn.gl_in[1u][0u].z * _150) * _131)) + ((patchIn.gl_in[2u][0u].y * _150) * _127)) + ((patchIn.gl_in[2u][0u].z * _139) * _136)) + ((((patchIn.in_var_PN_POSITION9 * float4(6.0)) * _136) * _127) * _131);
