...
[[ patch(triangle, 0) ]] vertex main0_out main0(main0_patchIn patchIn [[stage_in]], constant type_View& View [[buffer(0)]], constant type_ShadowDepthPass& ShadowDepthPass [[buffer(1)]], texture2d<float> Material_Texture2D_3 [[texture(0)]], sampler Material_Texture2D_3Sampler [[sampler(0)]], float3 gl_TessCoord [[position_in_patch]])
{
    ...
    float4 _202 = ((((((((((patchIn.gl_in[0u][1u].x * float4(_157)) * _165) + ((patchIn.gl_in[1u][1u].x * float4(_158)) * _169)) + ((patchIn.gl_in[2u][1u].x * float4(_159)) * _174)) + ((patchIn.gl_in[0u][1u].y * _177) * _169)) + ((patchIn.gl_in[0u][1u].z * _181) * _165)) + ((patchIn.gl_in[1u][1u].y * _181) * _174)) + ((patchIn.gl_in[1u][1u].z * _188) * _169)) + ((patchIn.gl_in[2u][1u].y * _188) * _165)) + ((patchIn.gl_in[2u][1u].z * _177) * _174)) + ((((patchIn.in_var_PN_POSITION9 * float4(6.0)) * _174) * _165) * _169);
    ...
    float4 _233 = ((patchIn.gl_in[0u][6u].x * _165) + (patchIn.gl_in[1u][6u].x * _169)) + (patchIn.gl_in[2u][6u].x * _174);
