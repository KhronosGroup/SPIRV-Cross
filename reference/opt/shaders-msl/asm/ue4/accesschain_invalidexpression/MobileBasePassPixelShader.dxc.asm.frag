...
struct type_MobileDirectionalLight
{
    ...
    unsafe_array<float4x4,4> MobileDirectionalLight_DirectionalLightScreenToShadow;
};

struct type_Globals
{
    int NumDynamicPointLights;
    unsafe_array<float4,4> LightPositionAndInvRadius;
    unsafe_array<float4,4> LightColorAndFalloffExponent;
