...
{
    {
        ...
        const auto spvTraceRayOrigin = float3(float(spvRayContext.launchId.x) / float(spvRayContext.launchSize.x), float(spvRayContext.launchId.y) / float(spvRayContext.launchSize.y), 1.0);
