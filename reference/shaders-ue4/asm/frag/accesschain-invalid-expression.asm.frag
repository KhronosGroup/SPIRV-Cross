...
struct type_MobileDirectionalLight
{
    ...
    spvUnsafeArray<float4x4, 4> MobileDirectionalLight_DirectionalLightScreenToShadow;
};

struct type_Globals
{
    int NumDynamicPointLights;
    spvUnsafeArray<float4, 4> LightPositionAndInvRadius;
    spvUnsafeArray<float4, 4> LightColorAndFalloffExponent;
